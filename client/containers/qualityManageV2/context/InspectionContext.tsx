...
export interface InspectionContextI {
...
const defaultContext: InspectionContextI = {
  hiddenDangerProblem: [],
...
export const InspectionContext = createContext<InspectionContextI>(
  defaultContext
);

export const InspectionContextProvider = ({
  children,
}: {
...
export default InspectionContextProvider;
